...
/**
 * PayPal Payment Option Component
 *
 * Add this to your existing billing/pricing page to offer PayPal as an alternative
 * to Stripe credit card payments.
 *
 * Usage in your BillingContent or PricingPage:
 * ```tsx
 * import { PayPalOption } from "@/components/billing/PayPalOption";
 *
 * // In your component:
 * <PayPalOption planId={1} />
 * ```
 */
...
interface PayPalOptionProps {
	...
	description?: string;
	/**
	 * Optional: Show as alternative payment method (default: true)
	 */
...
export function PayPalOption({
	...
	description = "Subscribe using your PayPal account for secure monthly billing",
			...
			<CardContent>
				...
				{showAsAlternative && (
					<div className="mt-4 rounded-md bg-blue-50 p-3">
						<h4 className="text-sm font-medium text-blue-900">Why choose PayPal?</h4>
						<ul className="mt-2 space-y-1 text-xs text-blue-700">
							<li>✓ No credit card required if you have a PayPal balance</li>
							<li>✓ Manage subscription directly from your PayPal account</li>
