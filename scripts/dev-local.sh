...
# Find and temporarily modify both route.ts and page.tsx files with edge runtime
find src/app -type f \( -name "route.ts" -o -name "page.tsx" \) -exec grep -l "export const runtime = 'edge'" {} \; > /tmp/runtime-files.txt
